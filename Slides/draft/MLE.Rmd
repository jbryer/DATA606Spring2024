...
date: "`r Sys.Date()`"
# This custom call to knit will copy the generated HTML file and any dependencies
# to the docs/slides folder to be available on the website (see myknit.R)
...
```{r, echo=FALSE}
path <- paste0(find.package('DATA606'), '/shiny/mle')
path <- '~/Dropbox/School/Teaching/DATA606/inst/shiny/mle'
shiny::shinyAppDir(path,  options = list(width = "100%", height = 700))
```
